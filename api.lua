function mineralberries.register_berry(ore, ore_name, oreblock, berry_texture, bush_texture, berry_bush_texture, berries_dropped, growth_time, bush_rarity)
    ...
    core.register_decoration({
        ...
        place_on = {oreblock},
        sidelen = 16,
        fill_ratio = (1/bush_rarity or 0.01)*mineralberries.settings.rarity_multiplier,
        biomes = {"all"},
        y_max = 31000,
        y_min = -31000,
...
mineralberries.register_berry("default:coal_lump", "Coal", "default:stone_with_coal", "mineralberries_coal_bush_with_berries.png", "mineralberries_bush.png", "mineralberries_bush.png^mineralberries_coal_bush_with_berries.png", 2, 300)